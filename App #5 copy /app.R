...
server <- function( input, output ) {
  ...
  output$availability <- renderPlot ({
    plot( availabilityData$Median.availability.of.selected.generic.medicines.......Private,
          availabilityData$Median.availability.of.selected.generic.medicines.......Public, 
          xlab = "Median Private Availability Percentage",
          ylab = "Median Public Availability Percentage")
    abline(lm(availabilityData$Median.availability.of.selected.generic.medicines.......Public~availabilityData$Median.availability.of.selected.generic.medicines.......Private,
              col = "blue"))
  })
  
  output$priceRatio <- renderPlot ({
    plot( priceData$Median.consumer.price.ratio.of.selected.generic.medicines...Private, 
          priceData$Median.consumer.price.ratio.of.selected.generic.medicines...Public, 
          xlab = "Median Private Consumer Price Ratio", 
          ylab = "Median Public Consumer Price Ratio")
    abline(lm(priceData$Median.consumer.price.ratio.of.selected.generic.medicines...Public~priceData$Median.consumer.price.ratio.of.selected.generic.medicines...Private,
              col = "blue"))
  })
